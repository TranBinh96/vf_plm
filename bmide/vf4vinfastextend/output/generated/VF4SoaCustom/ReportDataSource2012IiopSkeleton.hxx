...
//#ifndef TEAMCENTER_SERVICES_Custom__2020_12_ReportDataSource_HXX 
//#define TEAMCENTER_SERVICES_Custom__2020_12_ReportDataSource_HXX
...
private:
    ...
    static void get150BomWithVariantsDS( const std::string& xmlIn,  Teamcenter::Soa::Internal::Gateway::GatewayResponse& gatewayResponse );
    
    static void getPFEPReport( const std::string& xmlIn,  Teamcenter::Soa::Internal::Gateway::GatewayResponse& gatewayResponse );
    
    static void getProcessStatusReport( const std::string& xmlIn,  Teamcenter::Soa::Internal::Gateway::GatewayResponse& gatewayResponse );
