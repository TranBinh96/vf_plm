...
public class DMTargetCostReportDialog extends JFrame{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DMTargetCostReportDialog frame = new DMTargetCostReportDialog();
	 ...
	 * Create the frame.
	 */
	public DMTargetCostReportDialog() {
...
//		btnLeft.setHorizontalAlignment(SwingConstants.RIGHT);
		...
		sl_panel_1.putConstraint(SpringLayout.NORTH, label, 10, SpringLayout.NORTH, panel_1);
