...
public class ModuleGroupEnglishPopulateDialog extends AbstractAIFDialog{
	...
	public ModuleGroupEnglishPopulateDialog(TCComponentBOMLine selectedLine, TCComponentBOMLine []bomlines, TCSession session) throws TCException {
		...
		endMessage = "Please verify the updated content and Click on “Save” button to commit the values.";
	}
	...
	public void createAndShowGUI() throws Exception {
		...
		Dimension fixedSize = new Dimension(326, 95);
