...
public class StringExtension {
	public static String fileNameAvailableCharacters = "^[a-zA-Z0-9_\\-. ]*$";
	...
	public static LinkedHashMap<String, String> GetComboboxValue(String[] inputList, String value) {
		...
		return TCExtension.SortingLOV(outputList);
	}
...
//	        }
	...
	public static Calendar getDatetimeFromWidget(DateTime control) {
		Calendar cal = Calendar.getInstance();
	...
	public static String getStringBetweenKeyword(String inputString, String startKeyword, String endKeyword) {
	...
	public static String[] convertStringToArray(String inputStr) {
