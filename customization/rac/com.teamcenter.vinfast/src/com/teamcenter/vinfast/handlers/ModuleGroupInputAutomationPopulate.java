...
import com.vf.dialog.ModuleGroupEnglishPopulateDialog;

public class ModuleGroupInputAutomationPopulate  extends AbstractHandler{
	...
	public ModuleGroupInputAutomationPopulate() {
		super();
	}
...
//		TCComponentBOMLine[] bomlines = Arrays.asList(appComps).toArray(new TCComponentBOMLine[0]);
		...
		try {
			ModuleGroupEnglishPopulateDialog dlg = new ModuleGroupEnglishPopulateDialog((TCComponentBOMLine)parentLine, bomlines.toArray(new TCComponentBOMLine[0]), session);
