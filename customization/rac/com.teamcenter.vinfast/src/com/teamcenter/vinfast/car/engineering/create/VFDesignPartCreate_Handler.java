...
public class VFDesignPartCreate_Handler extends AbstractHandler {
	private TCSession session;
	private VFDesignPartCreate_Dialog dlg;
	private TCComponent selectedObject = null;
	private static String VINF_DESIGNPART_CREATE_CONFIG = "VINF_DESIGNPART_CREATE_CONFIG";
	...
	public VFDesignPartCreate_Handler() {
		super();
	}
	...
	public Object execute(ExecutionEvent arg0) throws ExecutionException {
		try {
			...
			isFirstCheck = true;
			if (command.contains("newPartFromBasePart")) {
				isFromBasePart = true;
			...
			// Init data
			partNumberRuleMapping = new LinkedHashMap<String, Map<String, String>>();
			partNumberRuleMapping.put("VF3", new HashMap<String, String>() {
				{
					put("Design Part New", "A");
					put("Design Part After PR", "A");
					put("Prototype Part New", "P");
					put("Prototype Part After PR", "P");
					put("In House Part New", "H");
					put("In House Part After PR", "H");
					put("Soft Tool Part New", "S");
					put("Soft Tool Part After PR", "S");
					put("Software Part", "A");
					put("Software Part After PR", "A");
					put("ECU Part New", "A");
					put("ECU Part After PR", "A");
				}
			});
			partNumberRuleMapping.put("VF31", new HashMap<String, String>() {
				{
					put("Design Part New", "");
					put("Design Part After PR", "A");
					put("Prototype Part New", "P");
					...
					put("Soft Tool Part After PR", "S");
					put("Software Part", "");
					put("Software Part After PR", "");
					put("ECU Part New", "");
					put("ECU Part After PR", "");
				}
			});
			partNumberRuleMapping.put("VF31_RHD", new HashMap<String, String>() {
				{
					put("Design Part New", "A");
					put("Design Part After PR", "A");
					put("Prototype Part New", "P");
			...
			partNumberRuleMapping.put("VFe32", new HashMap<String, String>() {
				{
					put("Design Part New", "A");
					put("Design Part After PR", "A");
					put("Prototype Part New", "P");
			...
			partNumberRuleMapping.put("VFe33", new HashMap<String, String>() {
				{
					put("Design Part New", "");
					put("Design Part After PR", "A");
					put("Prototype Part New", "P");
			...
			partNumberRuleMapping.put("VFe34NG", new HashMap<String, String>() {
				{
					put("Design Part New", "");
					put("Design Part After PR", "A");
					put("Prototype Part New", "P");
			...
			partNumberRuleMapping.put("VF32", new HashMap<String, String>() {
				{
					put("Design Part New", "");
					put("Design Part After PR", "A");
					put("Prototype Part New", "P");
			...
			partNumberRuleMapping.put("VF33", new HashMap<String, String>() {
				{
					put("Design Part New", "");
					put("Design Part After PR", "A");
					put("Prototype Part New", "P");
			...
			partNumberRuleMapping.put("Ebus10", new HashMap<String, String>() {
				{
					put("Design Part New", "");
					put("Design Part After PR", "A");
					put("Prototype Part New", "P");
			...
			partNumberRuleMapping.put("Ebus12", new HashMap<String, String>() {
				{
					put("Design Part New", "A");
					put("Design Part After PR", "A");
					put("Prototype Part New", "P");
			...
			partNumberRuleMapping.put("VF8NP", new HashMap<String, String>() {
				{
					put("Design Part New", "A");
					put("Design Part After PR", "A");
					put("Prototype Part New", "P");
			...
			partNumberRuleMapping.put("VF9NP", new HashMap<String, String>() {
				{
					put("Design Part New", "A");
					put("Design Part After PR", "A");
					put("Prototype Part New", "P");
			...
			String[] typeDataForm = new String[] { "Design Part", "Prototype Part", "In House Part", "Soft Tool Part", "Software Part", "ECU Part" };
			...
			String[] cuvTypeDataForm = TCExtension.GetLovValues("vf4_cuv_veh_type", "VF4_DesignRevision", session);
			String[] softwarepartTypeDataForm = TCExtension.GetLovValues("vf4_software_part_type", "VF4_Design", session);
			String[] isModifiedPartDataForm = TCExtension.GetLovValues("vf4_is_modified_part", "VF4_Design", session);
			String[] moduleGrpLov = TCExtension.GetLovValues("VL5_module_group", "BOMLine", session);
			// Init UI
			dlg = new VFDesignPartCreate_Dialog(new Shell());
			dlg.create();
			dlg.setTitle("Create VF Design Part");
			...
			dlg.cbType.addModifyListener(new ModifyListener() {
				...
				public void modifyText(ModifyEvent arg0) {
					boolean swPartTypeShow = (dlg.cbType.getText().compareTo("Software Part") == 0 || dlg.cbType.getText().compareTo("ECU Part") == 0);
					dlg.lblSoftwarePartType.setVisible(swPartTypeShow);
					dlg.cbSoftwarePartType.setVisible(swPartTypeShow);
			...
			dlg.cbSoftwarePartType.setItems(softwarepartTypeDataForm);
			dlg.cbOldPartModuleGrp.setItems(moduleGrpLov);
			...
			dlg.cbDonorVehicle.addModifyListener(new ModifyListener() {
				@Override
				public void modifyText(ModifyEvent arg0) {
					updatePartIDFormat();
				}
			...
			dlg.cbIsModifiedPart.addModifyListener(new ModifyListener() {
				...
				public void modifyText(ModifyEvent arg0) {
					...
					if (!value.isEmpty() && value.compareToIgnoreCase("Yes") == 0) {
						// thanhpn6-open old part dialog when cbIsModifiedPart is True
						SearchDesignDialog searchDlg = new SearchDesignDialog(dlg.getShell(), dlg.getShell().getStyle(), "VF4_Design;VF4_scooter_veh;VF4_scooter_mod;VF3_Scooter_part");
						searchDlg.create();
			...
			if (isAddToBom) {
				...
				String donorVehicle = selectedBOMLine.getItem().getProperty("vf4_donor_vehicle");
	...
	private void updateInfoFromBasePart(BasePartInfo baseIn) {
		...
		dlg.cbDonorVehicle.setText(baseIn.bDonorVeh);
		...
		if (!baseIn.bSoftwarePartType.isEmpty()) {
			dlg.cbType.setText("Software Part");
			dlg.lblSoftwarePartType.setVisible(true);
			dlg.cbSoftwarePartType.setVisible(true);
			dlg.cbSoftwarePartType.setText(baseIn.bSoftwarePartType);
		} else {
			dlg.lblSoftwarePartType.setVisible(false);
			dlg.cbSoftwarePartType.setVisible(false);
		}
	...
	private void updatePartIDFormat() {
		...
		String type = dlg.cbType.getText();
		String donorVehicle = dlg.cbDonorVehicle.getText().isEmpty() ? "" : (String) dlg.cbDonorVehicle.getData(dlg.cbDonorVehicle.getText());
		boolean isRHD = Arrays.asList(dlg.lstVehicleType.getItems()).contains("RHD");

		if (type.isEmpty() || donorVehicle.isEmpty())
			return;

		if (isRHD) {
			if (partNumberRuleMapping.containsKey(donorVehicle + "_RHD"))
				donorVehicle += "_RHD";
		}

		if (partNumberRuleMapping.containsKey(donorVehicle)) {
			Map<String, String> donorVehicleMapping = partNumberRuleMapping.get(donorVehicle);
	...
	public static String getNewSuffixPartNum(String suffix, String currentPartNumber, TCSession session) {
		...
		queryInput.put("Type", "VF4_Design");
	...
	private Boolean checkRequired() {
		...
		if (dlg.cbDonorVehicle.getText().isEmpty()) {
			warningLabel(dlg.lblDonorVehicle, true);
			check = false;
		} else {
			warningLabel(dlg.lblDonorVehicle, false);
		}
		if (dlg.cbSoftwarePartType.getVisible() && dlg.cbSoftwarePartType.getText().isEmpty()) {
			warningLabel(dlg.lblSoftwarePartType, true);
			check = false;
		} else {
			warningLabel(dlg.lblSoftwarePartType, false);
		}
	...
	private boolean checkSWPartRule() {
		boolean check = true;
		String id = dlg.txtID.getText() + dlg.txtSuffID.getText();
		if (id.length() > 3) {
			String preID = id.substring(0, 3);
			if (preID.toUpperCase().compareToIgnoreCase("SOW") == 0) {
				if (!dlg.lblSoftwarePartType.getVisible()) {
					if (dlg.cbType.getText().compareTo("Software Part") == 0) {
						warningLabel(dlg.lblID, true);
						check = false;
					} else {
						warningLabel(dlg.lblID, false);
	...
	private void createNewItem() {
		try {
			...
			if (!checkSWPartRule()) {
				dlg.setMessage("Please select \"Software Part\" for SOW part", IMessageProvider.WARNING);
				return;
			}

			if (!dlg.txtOldPartNumber.getText().isEmpty() && dlg.cbOldPartModuleGrp.getText().isEmpty()) {
				dlg.setMessage("Please input Module Group of old part", IMessageProvider.WARNING);
				return;
			}
			String id = dlg.txtID.getText() + dlg.txtSuffID.getText();
			...
			String softwarePartType = dlg.cbSoftwarePartType.getText();
			String isModifiedPart = dlg.cbIsModifiedPart.getText();
			...
			itemDef.clientId = "1";
			itemDef.data.boName = "VF4_Design";
			...
			itemDef.data.stringProps.put("vf4_vf_code", dlg.cbOldPartModuleGrp.getText());
			if (dlg.lblSoftwarePartType.getVisible())
				itemDef.data.stringProps.put("vf4_software_part_type", softwarePartType);
			itemDef.data.stringProps.put("vf4_is_modified_part", isModifiedPart);

			CreateInput revDef = new CreateInput();
			revDef.boName = "VF4_DesignRevision";
			...
			if (response.serviceData.sizeOfPartialErrors() == 0) {
				...
				for (TCComponent rev : response.output[0].objects) {
					if (rev.getType().equals("VF4_DesignRevision")) {
