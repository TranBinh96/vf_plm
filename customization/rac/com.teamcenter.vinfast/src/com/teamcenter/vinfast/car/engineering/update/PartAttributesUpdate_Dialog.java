...
public class PartAttributesUpdate_Dialog extends TitleAreaDialog {
	...
	private Label lblColoredPart;
	public Text txtColorCode;
	public Combo cbColoredPart;
	public Button btnInfoColorCode;
	public Button btnInfoColoredPart;
	
	public PartAttributesUpdate_Dialog(Shell parentShell) throws TCException {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		try {
			...
			}
			{
				...
				lblHomologationCountries.setLayoutData(new GridData(SWT.FILL, SWT.TOP, false, false, 1, 1));
			...
			{
				lblColorCode = new Label(container, SWT.NONE);
			...
			{
				btnInfoColorCode = new Button(container, SWT.NONE);
				btnInfoColorCode.setImage(ResourceManager.getPluginImage("com.teamcenter.vinfast", "icons/info_16.png"));
			}
			{
				lblColoredPart = new Label(container, SWT.NONE);
				lblColoredPart.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false, false, 1, 1));
				lblColoredPart.setText("Colored Part:");
				lblColoredPart.setBackground(SWTResourceManager.getColor(SWT.COLOR_WHITE));
			}
			{
				cbColoredPart = new Combo(container, SWT.READ_ONLY);
				cbColoredPart.setBackground(SWTResourceManager.getColor(SWT.COLOR_WHITE));
				cbColoredPart.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 1, 1));
			}
			{
				btnInfoColoredPart = new Button(container, SWT.NONE);
				btnInfoColoredPart.setImage(ResourceManager.getPluginImage("com.teamcenter.vinfast", "icons/info_16.png"));
			}
		}
		catch(Exception ex ) {
