...
public class VFTEDocumentCreate_Composite extends SpecDocumentCreateAbstract {
//	private Text txtID;
...
//	private Button ckbTargetReviseDate;
	...
	public VFTEDocumentCreate_Composite(Composite c) {
		super(c);
		...
		lblAddingNumber.setText("DVP Number: (*)");
	...
	private void updateIDForVFTE() {
		try {
			...
			cbModelCode.setText(modelCodeDataForm.get(modelCode));
			cbModuleName.setText(moduleNameDataForm.get(moduleName));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
