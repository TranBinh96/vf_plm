...
public class VFDesignPartCreate_Dialog extends TitleAreaDialog {
	...
	public Label lblSoftwarePartType;
	public Combo cbSoftwarePartType;
	...
	public Combo cbOldPartModuleGrp;
	...
	public VFDesignPartCreate_Dialog(Shell parentShell) throws TCException {
		super(parentShell);
			...
			tabFolder.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true, 5, 1));
			{
				...
				tbtmNewPartItem.setText("Part Attributes");
				{
					...
					new Label(container, SWT.NONE);
					{
						...
						lblOriginalBasePart.setText("Original Base Part Number/Module Group: (*)");
					}
					{
					...
					{
						cbOldPartModuleGrp = new Combo(container, SWT.READ_ONLY);
						GridData gd_cbModuleGrp = new GridData(SWT.FILL, SWT.CENTER, true, false, 1, 1);
						gd_cbModuleGrp.widthHint = 1;
						cbOldPartModuleGrp.setLayoutData(gd_cbModuleGrp);
					}
					new Label(container, SWT.NONE);
					{
					...
					{
						lblSoftwarePartType = new Label(container, SWT.NONE);
						lblSoftwarePartType.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false, false, 1, 1));
						lblSoftwarePartType.setText("Software Part Type: (*)");
						lblSoftwarePartType.setVisible(false);
					}
					{
						cbSoftwarePartType = new Combo(container, SWT.READ_ONLY);
						cbSoftwarePartType.setBackground(SWTResourceManager.getColor(SWT.COLOR_WHITE));
						cbSoftwarePartType.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 2, 1));
						cbSoftwarePartType.setVisible(false);
					}
					new Label(container, SWT.NONE);
				}
	...
	protected void configureShell(Shell newShell) {
		...
		newShell.setText("VF Design Part");
	}
}
