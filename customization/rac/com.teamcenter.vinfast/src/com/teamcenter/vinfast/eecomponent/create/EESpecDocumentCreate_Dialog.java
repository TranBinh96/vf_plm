...
public class EESpecDocumentCreate_Dialog extends TitleAreaDialog {
	...
	public EESpecDocumentCreate_Dialog(Shell parentShell) throws TCException {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		try {
			setTitle("Create EE Spec Document");
	...
	protected void configureShell(Shell newShell) {
		...
		newShell.setText("Create EE Spec Document");
	}
}
