...
public class EEComponentSORProcessTrigger_Dialog extends Dialog {
	...
	public EEComponentSORProcessTrigger_Dialog(Shell parentShell) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		try {
			...
			}
			{
				...
				lblVehicleType.setBackground(SWTResourceManager.getColor(SWT.COLOR_WHITE));
			}
			{
				cbVehicleType = new Combo(container, SWT.READ_ONLY);
				cbVehicleType.setBackground(SWTResourceManager.getColor(SWT.COLOR_WHITE));
				cbVehicleType.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 3, 1));
			}
			{
				...
				tabFolder.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true, 4, 1));
				{
					...
					tbtmBomInfo.setText("Bom Info");
					{
						...
						new Label(composite_1, SWT.NONE);
						{
							...
							lblAllowedObjectType.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 3, 1));
						...
						}
						{
							...
							}
							{
								...
								tblclmnNewColumn.setText("Make/Buy");
							}
							{
	...
	protected void configureShell(Shell newShell) {
		...
		newShell.setText("EEComponent SOR Process");
	}
