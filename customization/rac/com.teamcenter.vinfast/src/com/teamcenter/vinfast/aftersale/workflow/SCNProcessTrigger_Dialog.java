...
public class SCNProcessTrigger_Dialog extends Dialog {
	...
	public SCNProcessTrigger_Dialog(Shell parentShell) throws TCException {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		try {
			...
			container.setLayoutData(new GridData(GridData.FILL_BOTH));
			{
				...
				lblMessage.setText("Trigger ECR Process");
