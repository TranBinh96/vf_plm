...
public class AFSSORProcessTrigger_Dialog extends Dialog {
	...
	public AFSSORProcessTrigger_Dialog(Shell parentShell) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		try {
			...
			container.setLayoutData(new GridData(GridData.FILL_BOTH));
			{
				...
				GridData gd_lblMessage = new GridData(SWT.FILL, SWT.CENTER, true, false, 4, 1);
				gd_lblMessage.heightHint = 65;
				lblMessage.setLayoutData(gd_lblMessage);
				lblMessage.setText("Trigger AFS SOR Process");
			...
			new Label(container, SWT.NONE);
			{
				...
				GridData gd_tabFolder = new GridData(SWT.FILL, SWT.FILL, true, true, 4, 1);
				gd_tabFolder.widthHint = 566;
				tabFolder.setLayoutData(gd_tabFolder);
				{
					...
					tbtmBomInfo.setText("Bom Info");
					{
						...
						new Label(composite_1, SWT.NONE);
						{
							...
							lblAllowedObjectType.setLayoutData(new GridData(SWT.FILL, SWT.FILL, false, false, 3, 1));
	...
	protected void configureShell(Shell newShell) {
		...
		newShell.setText("AFS SOR Process");
	}
