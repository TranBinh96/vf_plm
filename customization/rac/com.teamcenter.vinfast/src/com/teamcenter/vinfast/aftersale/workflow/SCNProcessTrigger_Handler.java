...
public class SCNProcessTrigger_Handler extends AbstractHandler {
	private TCSession session;
	private SCNProcessTrigger_Dialog dlg;
	...
	private final static String WORKPROCESS_TEMPLACE = "VINFAST_SCN_RELEASE_PROCESS";
	private String triggerMessage = "";

	public SCNProcessTrigger_Handler() {
		super();
	}
	...
	public Object execute(ExecutionEvent arg0) throws ExecutionException {
		try {
			...
			dlg = new SCNProcessTrigger_Dialog(new Shell());
			dlg.create();
	...
	private void fillDefaultData() throws Exception {
		String program = selectedObject.getPropertyDisplayableValue("vf4_vehicle_programs");
		...
		try {
			...
			progressMonitorDialog.run(true, false, new IRunnableWithProgress() {
				...
				public void run(IProgressMonitor monitor) throws InvocationTargetException, InterruptedException {
					...
					try {
						monitor.subTask("Trigger SCN process...");
