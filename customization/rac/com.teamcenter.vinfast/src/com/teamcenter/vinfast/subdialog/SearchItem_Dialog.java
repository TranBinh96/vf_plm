...
public class SearchItem_Dialog extends Dialog {
	...
	public SearchItem_Dialog(Shell parent, String objectType) {
		super(parent);
	...
	public void loadObjects() {
		...
		if (objects != null) {
			...
			for (TCComponent obj : objects) {
				try {
					String[] propValues = obj.getProperties(new String[] { "item_id", "object_name" });
					itemSearch.add(obj);
