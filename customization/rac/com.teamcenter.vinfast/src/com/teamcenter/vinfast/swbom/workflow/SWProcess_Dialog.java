...
public class SWProcess_Dialog extends Dialog {
	...
	public SWProcess_Dialog(Shell parentShell) throws TCException {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		try {
			...
			container.setLayoutData(new GridData(GridData.FILL_BOTH));
			{
				...
				lblMessage.setText("Trigger FRS/ECU Process");
	...
	protected void configureShell(Shell newShell) {
		...
		newShell.setText("FRS/ECU Release Process");
	}
