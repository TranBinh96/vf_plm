...
public class ECRCreate_Dialog extends TitleAreaDialog {
	...
	public Label lblPremiumVariant;
	...
	public Button ckbVehicleTVManager;
	public Button ckbVehicleArchitecture;
	public Button ckbCAE;
	public Button ckbSaleProductMarketing;
	public Button ckbEETVManager;
	public Button ckbComponentTestingManager;
	...
	public Label lblScrapCost;
	public Text txtScrapCost;
	...
	public Combo cbScrapCostRequired;
	...
	public Button ckbIDP;
	public Table tblCoordinatedChange;
	private TableColumn tblclmnNewColumn;
	private TableColumn tblclmnNewColumn_1;
	private TableColumn tblclmnNewColumn_2;
	public Table tblSIL;
	public Button btnIMSRemove;
	public Button btnIMSAdd;
	private TableColumn tblclmnNewColumn_3;
	private TableColumn tblclmnNewColumn_4;

	public ECRCreate_Dialog(Shell parentShell) throws TCException {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		try {
			...
			{
				scrolledComposite = new ScrolledComposite(grpSummary, SWT.BORDER | SWT.V_SCROLL);
				...
				scrolledComposite.setExpandVertical(true);
				{
					...
					{
						cbVehicleGroup = new Combo(composite, SWT.READ_ONLY);
						cbVehicleGroup.setFont(SWTResourceManager.getFont("Segoe UI", 8, SWT.NORMAL));
						cbVehicleGroup.setBackground(SWTResourceManager.getColor(SWT.COLOR_WHITE));
						cbVehicleGroup.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 3, 1));
					}
					...
					}
					{
						...
						txtECRContactPerson.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 3, 1));
					}
					new Label(composite, SWT.NONE);
					{
					...
					}
					{
						...
						GridData gd_txtDescription = new GridData(SWT.FILL, SWT.CENTER, false, false, 3, 2);
					...
					}
					{
						...
						txtECRContactEmail.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 3, 1));
					}
					new Label(composite, SWT.NONE);
					new Label(composite, SWT.NONE);
					new Label(composite, SWT.NONE);
					...
					}
					{
						...
						cbECRCategory.setLayoutData(new GridData(SWT.FILL, SWT.TOP, true, false, 3, 1));
					}
					new Label(composite, SWT.NONE);
					{
						lblImpactedModule = new Label(composite, SWT.NONE);
						lblImpactedModule.setLayoutData(new GridData(SWT.FILL, SWT.TOP, false, false, 1, 2));
					...
					}
					{
						...
						lblECRCategory2.setLayoutData(new GridData(SWT.FILL, SWT.TOP, false, false, 1, 2));
						lblECRCategory2.setText("ECR Category Level 2: (*)");
					}
					{
						lstECRCategory2 = new List(composite, SWT.BORDER);
						GridData gd_lstECRCategory2 = new GridData(SWT.FILL, SWT.CENTER, false, false, 3, 1);
					...
					}
					{
						...
						cbECRCategory2.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 3, 1));
					}
					{
					...
					}
					{
						...
						GridData gd_lstImplementationDate = new GridData(SWT.FILL, SWT.CENTER, false, false, 3, 2);
					...
					}
					{
						...
						cbChangeReason.setLayoutData(new GridData(SWT.FILL, SWT.TOP, false, false, 3, 1));
					...
					}
					{
						...
						cbNewPartStatus.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 3, 1));
					}
					new Label(composite, SWT.NONE);
					new Label(composite, SWT.NONE);
					{
					...
					}
					{
						...
						txtDCRNo.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 2, 1));
					}
					new Label(composite, SWT.NONE);
					{
					...
					}
					{
						...
						GridData gd_cbHaveDMUCheckRequired = new GridData(SWT.FILL, SWT.CENTER, false, false, 1, 1);
					...
					}
					{
						...
						txtDMUCheckFile.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 2, 1));
					}
					{
					...
					}
					{
						...
						lblNewLabel.setLayoutData(new GridData(SWT.LEFT, SWT.CENTER, false, false, 10, 1));
						lblNewLabel.setForeground(SWTResourceManager.getColor(SWT.COLOR_RED));
						lblNewLabel.setFont(SWTResourceManager.getFont("Segoe UI", 9, SWT.BOLD));
						lblNewLabel.setText("Yes: have task transfer data required in system. No: not have task transfer data required in system, must input reason.");
					}
					{
					...
					}
					{
						...
						GridData gd_cbSILNo = new GridData(SWT.FILL, SWT.CENTER, false, false, 2, 1);
						gd_cbSILNo.widthHint = 30;
						cbSILNoRequired.setLayoutData(gd_cbSILNo);
					}
					{
						tblSIL = new Table(composite, SWT.BORDER | SWT.FULL_SELECTION);
						GridData gd_tblSIL = new GridData(SWT.FILL, SWT.FILL, true, false, 6, 2);
						gd_tblSIL.heightHint = 50;
						tblSIL.setLayoutData(gd_tblSIL);
						tblSIL.setHeaderVisible(true);
						tblSIL.setLinesVisible(true);
						{
							tblclmnNewColumn_3 = new TableColumn(tblSIL, SWT.NONE);
							tblclmnNewColumn_3.setWidth(100);
							tblclmnNewColumn_3.setText("IMS Number");
						}
						{
							tblclmnNewColumn_4 = new TableColumn(tblSIL, SWT.NONE);
							tblclmnNewColumn_4.setWidth(100);
							tblclmnNewColumn_4.setText("SIL Severity");
						}
					}
					{
						btnIMSRemove = new Button(composite, SWT.NONE);
						btnIMSRemove.setImage(ResourceManager.getPluginImage("com.teamcenter.vinfast", "icons/remove_16.png"));
						btnIMSRemove.setFont(SWTResourceManager.getFont("Segoe UI", 8, SWT.NORMAL));
					}
					new Label(composite, SWT.NONE);
					new Label(composite, SWT.NONE);
					new Label(composite, SWT.NONE);
					{
						btnIMSAdd = new Button(composite, SWT.NONE);
						btnIMSAdd.setLayoutData(new GridData(SWT.LEFT, SWT.TOP, false, false, 1, 1));
						btnIMSAdd.setImage(ResourceManager.getPluginImage("com.teamcenter.vinfast", "icons/search.png"));
						btnIMSAdd.setFont(SWTResourceManager.getFont("Segoe UI", 8, SWT.NORMAL));
					}
					{
					...
					}
					{
						...
						GridData gd_cbCoordinatedChage = new GridData(SWT.FILL, SWT.CENTER, false, false, 2, 1);
						gd_cbCoordinatedChage.widthHint = 30;
						cbCoordinatedChageRequired.setLayoutData(gd_cbCoordinatedChage);
					}
					{
						tblCoordinatedChange = new Table(composite, SWT.BORDER | SWT.FULL_SELECTION);
						GridData gd_tblCoordinatedChange = new GridData(SWT.FILL, SWT.FILL, true, false, 6, 2);
						gd_tblCoordinatedChange.widthHint = 434;
						gd_tblCoordinatedChange.heightHint = 50;
						tblCoordinatedChange.setLayoutData(gd_tblCoordinatedChange);
						tblCoordinatedChange.setHeaderVisible(true);
						tblCoordinatedChange.setLinesVisible(true);
						{
							tblclmnNewColumn = new TableColumn(tblCoordinatedChange, SWT.NONE);
							tblclmnNewColumn.setWidth(100);
							tblclmnNewColumn.setText("ECR Number");
						}
						{
							tblclmnNewColumn_1 = new TableColumn(tblCoordinatedChange, SWT.NONE);
							tblclmnNewColumn_1.setWidth(200);
							tblclmnNewColumn_1.setText("ECR Title");
						}
						{
							tblclmnNewColumn_2 = new TableColumn(tblCoordinatedChange, SWT.NONE);
							tblclmnNewColumn_2.setWidth(350);
							tblclmnNewColumn_2.setText("Implementation Date");
						}
					}
					{
					...
					new Label(composite, SWT.NONE);
					{
						...
						btnECRAdd.setLayoutData(new GridData(SWT.LEFT, SWT.TOP, false, false, 1, 1));
			...
			{
				lblPremiumVariant = new Label(grpPrecab, SWT.NONE);
				lblPremiumVariant.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false, false, 1, 1));
				lblPremiumVariant.setText("Premium Variant: (*)");
			}
			{
				cbPremiumVariant = new Combo(grpPrecab, SWT.READ_ONLY);
				cbPremiumVariant.setFont(SWTResourceManager.getFont("Segoe UI", 8, SWT.NORMAL));
				cbPremiumVariant.setBackground(SWTResourceManager.getColor(SWT.COLOR_WHITE));
				cbPremiumVariant.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 2, 1));
			}
			new Label(grpPrecab, SWT.NONE);
			{
				lblSeat = new Label(grpPrecab, SWT.NONE);
				lblSeat.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false, false, 1, 1));
				lblSeat.setText("Seat:");
			}
			{
				cbSeat = new Combo(grpPrecab, SWT.READ_ONLY);
				cbSeat.setFont(SWTResourceManager.getFont("Segoe UI", 8, SWT.NORMAL));
				cbSeat.setBackground(SWTResourceManager.getColor(SWT.COLOR_WHITE));
				cbSeat.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 2, 1));
			}
			new Label(grpPrecab, SWT.NONE);
			{
			...
			}
			{
				...
				grpChangeDescription.setLayout(new GridLayout(4, false));
				...
				}
				{
					...
					txtCurrentMaterial.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 2, 1));
				}
				{
				...
				}
				{
					...
					txtNewMaterial.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 2, 1));
				}
				{
			...
			}
			{
				...
				{
					ckbVehicleArchitecture = new Button(grpDocumentation, SWT.CHECK);
					ckbVehicleArchitecture.setLayoutData(new GridData(SWT.LEFT, SWT.CENTER, true, false, 1, 1));
					ckbVehicleArchitecture.setText("Vehicle Architecture/DMU");
				}
				{
					ckbHomologation = new Button(grpDocumentation, SWT.CHECK);
					ckbHomologation.setLayoutData(new GridData(SWT.LEFT, SWT.CENTER, true, false, 1, 1));
					ckbHomologation.setText("Homologation");
				}
				{
					ckbCAE = new Button(grpDocumentation, SWT.CHECK);
					ckbCAE.setLayoutData(new GridData(SWT.LEFT, SWT.CENTER, true, false, 1, 1));
					ckbCAE.setText("CAE");
				}
				{
				...
				{
					ckbStandardPart = new Button(grpDocumentation, SWT.CHECK);
					ckbStandardPart.setText("Standard Part");
				}
				{
				...
				{
					ckbColorTrim = new Button(grpDocumentation, SWT.CHECK);
					ckbColorTrim.setText("Styling and Color Trim");
					ckbColorTrim.setTouchEnabled(true);
				}
				{
				...
				{
					ckbSaleProductMarketing = new Button(grpDocumentation, SWT.CHECK);
					ckbSaleProductMarketing.setText("Sale and Product Marketing");
				}
				{
					ckbVehicleTVManager = new Button(grpDocumentation, SWT.CHECK);
					ckbVehicleTVManager.setText("Vehicle TV Manager");
				}
				{
					ckbComponentTestingManager = new Button(grpDocumentation, SWT.CHECK);
					ckbComponentTestingManager.setText("Component Testing Manager");
				}
				{
					ckbEETVManager = new Button(grpDocumentation, SWT.CHECK);
					ckbEETVManager.setText("EE TV Manager");
				}
				{
					ckbHTKO1 = new Button(grpDocumentation, SWT.CHECK);
					ckbHTKO1.setText("Is HTKO1 Required");
				}
				{
					ckbHTKO2 = new Button(grpDocumentation, SWT.CHECK);
					ckbHTKO2.setText("Is HTKO2 Required");
				}
				{
					ckbIDP = new Button(grpDocumentation, SWT.CHECK);
					ckbIDP.setText("In-Direct Purchase");
				}
			}
			...
			}
			{
				...
				}
				{
					...
					{
						lblScrapCost = new Label(grpInitCost, SWT.NONE);
						lblScrapCost.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false, false, 1, 1));
						lblScrapCost.setText("Scrap Cost: (*)");
					}
					{
						cbScrapCostRequired = new Combo(grpInitCost, SWT.READ_ONLY);
						cbScrapCostRequired.setFont(SWTResourceManager.getFont("Segoe UI", 8, SWT.NORMAL));
						cbScrapCostRequired.setBackground(SWTResourceManager.getColor(SWT.COLOR_WHITE));
						GridData gd_cbScrapCost = new GridData(SWT.FILL, SWT.CENTER, false, false, 1, 1);
						gd_cbScrapCost.widthHint = 30;
						cbScrapCostRequired.setLayoutData(gd_cbScrapCost);
					}
					{
						txtScrapCost = new Text(grpInitCost, SWT.BORDER);
						txtScrapCost.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 1, 1));
						txtScrapCost.addVerifyListener(doubleVerify);
					}
					{
					...
					}
					{
						...
						lblOtherCost.setText("Other Cost (tax, logistic, advance payment...): (*)");
					}
					{
