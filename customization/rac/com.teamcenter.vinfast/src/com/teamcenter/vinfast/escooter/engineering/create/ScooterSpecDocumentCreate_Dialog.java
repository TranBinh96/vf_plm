...
public class ScooterSpecDocumentCreate_Dialog extends TitleAreaDialog {
	...
	public ScooterSpecDocumentCreate_Dialog(Shell parentShell) throws TCException {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		try {
			...
			setTitle("Create Scooter Spec Document");
	...
	protected void configureShell(Shell newShell) {
		...
		newShell.setText("Scooter Spec Document");
	}
}
