...
public class VerifyPDF_Dialog extends TitleAreaDialog {
	...
	public VerifyPDF_Dialog(Shell parentShell) {
		super(parentShell);
	...
	protected void configureShell(Shell newShell) {
		...
		newShell.setText("Verify PDF file");
	}
	...
	protected void createButtonsForButtonBar(Composite parent) {
		this.btnAccept = createButton(parent, 12, "Verify", false);
	}
}
