...
public class DVPRItemSearchDialog extends AbstractSWTDialog{
	...
	protected Control createDialogArea(Composite parent) {
		...
		lblPartNumber.setText("DVPR Number:");
		...
		partDetails.setText("DVPR Number");
	...
	public void loadObjects(TCSession session, String ID) {
		...
		if(ID.equals("")) {
			...
			String[] values = new String[] {ID, "VF3_spec_doc;VF3_AT_DVPR_doc"};
