...
public class ValidatorAFSEScooter implements IValidator {
	TCSession session;

	public ValidatorAFSEScooter() {
	...
	public List<ValidationResult> validate(TCComponent partBomLine) throws Exception {
		...
		Validator afterSaleRelevantValidate = new Validator(partBomLine, "Is After Sale Relevant") {
			@Override
		...
		validators.add(afterSaleRelevantValidate);
