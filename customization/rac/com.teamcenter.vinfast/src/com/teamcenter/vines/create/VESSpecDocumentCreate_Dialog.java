...
public class VESSpecDocumentCreate_Dialog extends TitleAreaDialog {
	...
	private Label lblModelCode_1;
	public Combo cbType;
	public Combo cbPrefixName;
	public Combo cbModelCode;
	public Combo cbModuleName;
	public Combo cbIndex;
	
	public VESSpecDocumentCreate_Dialog(Shell parentShell) throws TCException {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		try {
			...
			setTitle("Create VES Spec Document");
			...
			lblVehicleCategory.setText("Type: (*)");
			
			cbType = new Combo(container, SWT.READ_ONLY);
			cbType.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, false, 1, 1));
			...
			cbPrefixName.setLayoutData(new GridData(SWT.FILL, SWT.FILL, false, false, 1, 1));
			
			lblModelCode_1 = new Label(container, SWT.NONE);
			lblModelCode_1.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false, false, 1, 1));
			lblModelCode_1.setText("Index: (*)");
			lblModelCode_1.setBackground(SWTResourceManager.getColor(SWT.COLOR_WHITE));
			
			cbIndex = new Combo(container, SWT.READ_ONLY);
			cbIndex.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 1, 1));
	...
	protected void configureShell(Shell newShell) {
		...
		newShell.setText("Create VES Spec Document");
	}
}
