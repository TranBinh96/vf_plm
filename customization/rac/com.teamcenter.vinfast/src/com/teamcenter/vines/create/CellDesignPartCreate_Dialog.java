...
public class CellDesignPartCreate_Dialog extends TitleAreaDialog {
	...
	public CellDesignPartCreate_Dialog(Shell parentShell) throws TCException {
		super(parentShell);
	...
	protected void configureShell(Shell newShell) {
		...
		newShell.setText("VINES Cell Design Part");
	}
}
