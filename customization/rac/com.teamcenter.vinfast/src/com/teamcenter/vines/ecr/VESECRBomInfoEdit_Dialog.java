...
public class VESECRBomInfoEdit_Dialog extends Dialog {
	...
	public VESECRBomInfoEdit_Dialog(Shell parent) {
		super(parent);
	...
	protected Control createDialogArea(Composite parent) {
		...
		cbAftersaleRelevant = new Combo(composite, SWT.NONE);
	...
	public void initData(TCSession session, LinkedHashMap<String, String> bomInfo) {
		try {
			...
			if (bomInfo != null) {
				cbChangeType.setText(bomInfo.get(VESECRNameDefine.BOMINFO_CHANGE_TYPE));
				txtPOSID.setText(bomInfo.get(VESECRNameDefine.BOMINFO_POSID));
				cbDonorVehicle.setText(bomInfo.get(VESECRNameDefine.BOMINFO_DONOR_VEHICLE));
				txtLevel.setText(bomInfo.get(VESECRNameDefine.BOMINFO_STRUCTURE_LEVEL));
				cbSteering.setText(bomInfo.get(VESECRNameDefine.BOMINFO_STEERING));
				txtQuantity.setText(bomInfo.get(VESECRNameDefine.BOMINFO_QUANTITY));
				cbMaturityLevel.setText(bomInfo.get(VESECRNameDefine.BOMINFO_MATURITY_LEVEL));
				cbPurchaseLevel.setText(bomInfo.get(VESECRNameDefine.BOMINFO_PURCHASE_LEVEL));
				txtPartNo.setText(bomInfo.get(VESECRNameDefine.BOMINFO_PART_NUMBER));
				txtOldRev.setText(bomInfo.get(VESECRNameDefine.BOMINFO_OLD_VERSION));
				txtFrozenRev.setText(bomInfo.get(VESECRNameDefine.BOMINFO_FROZEN_REVISION));
				txtNewRev.setText(bomInfo.get(VESECRNameDefine.BOMINFO_NEW_VERSION));
				txtPartName.setText(bomInfo.get(VESECRNameDefine.BOMINFO_PART_NAME));
				txtOriginalPart.setText(bomInfo.get(VESECRNameDefine.BOMINFO_ORIGINAL_BASE_PART));
				txtVariantFormula.setText(bomInfo.get(VESECRNameDefine.BOMINFO_VARIANT_FORMULA));
				txtTorqueInfo.setText(bomInfo.get(VESECRNameDefine.BOMINFO_TORQUE_INFO));
				txtWeight.setText(bomInfo.get(VESECRNameDefine.BOMINFO_WEIGHT));
				txtChangeDesc.setText(bomInfo.get(VESECRNameDefine.BOMINFO_CHANGE_DESC));
				ckb3DData.setSelection(bomInfo.get(VESECRNameDefine.BOMINFO_3D_DATA_AFFECTED).compareTo("Yes") == 0);
				txtMaterial.setText(bomInfo.get(VESECRNameDefine.BOMINFO_MATERIAL));
				txtCoating.setText(bomInfo.get(VESECRNameDefine.BOMINFO_CAD_COATING));
				txtSpecbook.setText(bomInfo.get(VESECRNameDefine.BOMINFO_SPEC_BOOK));
				txtSupplier.setText(bomInfo.get(VESECRNameDefine.BOMINFO_SUPPLIER));
				txtSupplierContact.setText(bomInfo.get(VESECRNameDefine.BOMINFO_SUPPLIER_CONTACT));
				cbAftersaleRelevant.setText(bomInfo.get(VESECRNameDefine.BOMINFO_IS_AFTERSALE));
				cbExchangeability.setText(bomInfo.get(VESECRNameDefine.BOMINFO_EXCHANGEABILITY));
				cbPartTraceability.setText(bomInfo.get(VESECRNameDefine.BOMINFO_PART_TRACE));
				disableUI();
			}
		} catch (Exception e) {
			e.printStackTrace();
