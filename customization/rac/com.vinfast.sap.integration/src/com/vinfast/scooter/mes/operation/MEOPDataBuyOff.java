...
public class MEOPDataBuyOff extends MEOPDataAbstract {
	@Override
	...
	void xmlAppendBody(StringBuffer dataString) {
		dataString.append("<Operation ID=\"" + this.getMEOPID() + "\" Revision=\"" + this.getMEOPRevID() + "\" OperationType=\"" + "BuyOff" + "\">");
		...
		dataString.append("</WorkInstructions>");
		dataString.append("<AgingTime>" + this.getAgingTime() + "</AgingTime>");
		dataString.append("</OperationAttribute>");
