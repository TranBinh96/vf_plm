...
public class MEOPDataEcu extends MEOPDataAbstract {
	@Override
	...
	void xmlAppendBody(StringBuffer dataString) {
		...
		dataString.append("<ECU HWNumber=\"" + this.getHwPartNumber() + "\" HWVersion=\"" + this.getHwVersion() + "\" SWNumber=\"" + this.getSwPartNumber() + "\" SWVersion=\"" + this.getSwVersion() + "\">");
