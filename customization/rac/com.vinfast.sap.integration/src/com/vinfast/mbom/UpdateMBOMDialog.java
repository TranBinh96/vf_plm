...
public class UpdateMBOMDialog extends TitleAreaDialog {
	...
	public UpdateMBOMDialog(Shell parent) {
		super(parent);
	...
	protected Control createDialogArea(Composite parent) {
		setTitle("Update MBOM Shop");
		setMessage("Please fill all the fields to update MBOM", IMessageProvider.INFORMATION);
		...
		//Varaint Start
		Label lbVariant = new Label(container, SWT.NONE);
		GridData gd_lbRule = new GridData(SWT.LEFT, SWT.CENTER, false, false, 1, 1);
		gd_lbRule.verticalIndent = 10;
		gd_lbRule.horizontalIndent = 5;
		lbVariant.setLayoutData(gd_lbRule);
		lbVariant.setText("Variant :");

		cb_Variant = new Combo(container, SWT.READ_ONLY);
		GridData gd_cbRule = new GridData(SWT.FILL, SWT.CENTER, true, false, 1, 1);
		gd_cbRule.verticalIndent = 10;
		gd_cbRule.horizontalIndent = 5;
		cb_Variant.setLayoutData(gd_cbRule);
