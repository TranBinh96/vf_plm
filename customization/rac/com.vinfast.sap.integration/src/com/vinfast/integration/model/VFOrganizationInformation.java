...
public class VFOrganizationInformation extends OrganizationInformationAbstract{
	String serverType = null;
	public VFOrganizationInformation(String serverType) {
		super(ORG_TYPE.ORG_VINFAST);
