...
@Component({
  ...
  styleUrls: ['./job-master-list.component.css']
})
export class JobMasterListComponent implements OnInit {
  id: string;
  ...
  loadData() {
    ...
    this.taskscheduleService.JobMaster_GetAll(this.searchData).subscribe(x => {
