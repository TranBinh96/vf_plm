...
@Component({
  selector: 'app-email-sender-list',
  templateUrl: './email-sender-list.component.html',
  styleUrls: ['./email-sender-list.component.css']
})
export class EmailSenderListComponent implements OnInit {
  id: string;
  ...
  loadData() {
    ...
    this.dataPullerService.EmailSender_GetAll(this.searchData).subscribe(x => {
