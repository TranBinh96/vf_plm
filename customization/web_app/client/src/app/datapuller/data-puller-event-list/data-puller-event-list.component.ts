...
@Component({
  selector: 'app-data-puller-event-list',
  templateUrl: './data-puller-event-list.component.html',
  styleUrls: ['./data-puller-event-list.component.css']
})
export class DataPullerEventListComponent implements OnInit {
  id: string;
  ...
  loadData() {
    ...
    this.dataPullerService.DataPullerEventMaster_GetAll(this.searchData).subscribe(x => {
