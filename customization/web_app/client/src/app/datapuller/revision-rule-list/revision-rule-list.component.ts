...
@Component({
  selector: 'app-revision-rule-list',
  templateUrl: './revision-rule-list.component.html',
  styleUrls: ['./revision-rule-list.component.css']
})
export class RevisionRuleListComponent implements OnInit {
  id: string;
  ...
  loadData() {
    ...
    this.dataPullerService.RevisionRuleMaster_GetAll(this.searchData).subscribe(x => {
